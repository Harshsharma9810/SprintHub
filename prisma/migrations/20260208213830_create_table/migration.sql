...
-- CreateEnum
CREATE TYPE "IssueStatus" AS ENUM ('TODO', 'IN_PROGRESS', 'PR_SUBMITTED', 'QA_READY', 'QA_IN_PROGRESS', 'QA_PASSED', 'QA_FAILED', 'IN_REVIEW', 'BLOCKED', 'PRODUCT_REVIEW', 'DESIGN_NEEDED', 'NOT_READY', 'DONE');
